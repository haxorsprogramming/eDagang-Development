	  ...
	  <div class="row">
		...
		<div class="col-xs-12">
		  <div class="box box-solid box-warning">
			...
			echo form_open_multipart('logistic/create',['class'=>'form-horizontal']);?>
			  <div class="box-body">
				<div class="form-group">
				  ...
				  <div class="col-xs-3">
					...
					{
					?>
						<option value="<?php echo $item->logistic_item_id;?>"><?php echo $item->logistic_item_name .' ('. $item->logistic_unit_code_name .')';?></option>
					<?php }?>
					</select>
				  </div>
				</div>
