      ...
      <div class="content-wrapper">
		...
		<section class="content-header" >
			<!--<a href="<?=base_url()?>logistic/create" class="btn btn-success">Tambah Logistik</a>&nbsp;-->
                ...
                <?
            if($group_id=='1' or $group_id=='18' or $group_id=='11' OR $group_id=='14' OR $group_id=='16' or $group_id=='10' or $group_id=='5' or $group_id=='8' ){
                ?>
				  ...
				  <div class="row">
                    ...
                    <div class="col-xs-12 col-md-5">
						<div class="input-group">
                         ...
                         foreach($dm AS $ddm)
						{?>
                         <option value="<?=$ddm->material_id?>"><?=$ddm->material_name?></option>
                        <?
						  }
                         ?>
                         </select>
                  ...
                  <table id="logistics" class="table table-striped table-bordered table-hover">
					...
					<?php
                      ...
                      <tr id="tr<?=$logistic->logistic_id?>">
						...
						<td align="right"><?php echo $logistic->logistic_stock;?></td>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                           ...
                           <?
                            ...
                            foreach($nr AS $dnr){
                                ?>
                                <p><?=$noo.". ".$dnr->product_recipe_name?></p>
                                <?
                                $noo++;
                            }
                            ?>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            ?>
								...
								if($logistic->logistic_location_id==5){
								?>
										 <tr id="tr<?=$logistic->logistic_id?>">
							<td><?php echo $no++;?></td>
							<td><?php echo date('d-m-Y H:i:s',strtotime($logistic->created_time));?></td>
