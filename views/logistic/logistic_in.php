	  ...
	  <div class="row">
		<div class="col-xs-12">
		  <div class="box box-solid box-success">
			...
			echo form_open('logistic/addcart_logisticin');?>
				<div class="box-body">
			
					<div class="col-xs-6 col-md-3">
					  <label>Tanggal Terima</label>
						<input type="text" class="form-control" value="<? if ($this->session->userdata('created_time')!=""){echo $this->session->userdata('created_time');}else{ echo date("d-m-Y");}?>" name="created_time" id="created_time" >
					</div>
                    ...
                    <div class="col-xs-12 col-md-3">
					  <label>Keterangan</label>
						<input type="text" class="form-control"  name="logistic_description" value="<? if ($this->session->userdata('logistic_description')!=""){echo $this->session->userdata('logistic_description');}?>" >
					</div>
				</div>
				<div class="box-body">
				...
				<div class="box-body">
				  <table class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th class="text-center">Satuan Resep</th>
                  ...
                  //  print_r($this->cart->contents());
					...
					{
						$allmaterial	= $this->material_model->get_material_by_material_idresep($items['id']);
					  ...
					  <tr>
                        ...
                        <td align="center"><?php echo $material->satuan_belix;?></td>
                        <td align="center"><?php echo $material->konversi;?></td>
						<!--<td align="center"><?php //echo number_format($items['price'],0,',','.');?></td>-->
						<td align="center"><a href="<?php echo base_url();?>logistic/log_removein/<?php echo $items['rowid'];?>" class="glyphicon glyphicon-remove"></a></td>
					  </tr>
					<?php } ?>
						<!--<tr>
			  ...
			  <?php
				echo form_open('logistic/logistic_simpanin','class=form-horizontal');
				?>
