	  ...
	  <div class="row">
		<div class="col-xs-12">
         <div class="row">
        	...
        	<a class="btn btn-block btn-success" href="<?=base_url()?>report/sales">Detail</a>
            </div>
        </div>
        <br>
		  <div class="box box-solid box-success">
			<div class="box-header">
			  <h3 class="box-title">Laporan Rekap <?php echo $sub_title;?></h3>
			</div><!-- /.box-header -->
			<div class="box-body">
			  
				<?php echo form_open('report/sales_searchrekap');?>
                <div class="row">
				...
				<div class="col-xs-3 col-md-1">
					    <div class="input-group">
					       <a class="btn btn-primary pull-right" style="margin-right: 5px;" href="<?php echo base_url().'report'.'/sales_export_to_excelrekap/'.$start_date.'/'.$end_date.'/'.$v_metode.'/'.$v_kategory.'/'.$v_subkategory;?>"><i class="fa fa-download"></i> Export</a>
                        </div>
					</div><!-- /.input group -->
				<?php echo form_close();?>
			  </div>
