...
<html>
    ...
    <title><?php echo $this->session->userdata('company_name');?> - Orders</title>
	...
	<script type="text/javascript">
		setInterval("auto_refresh_function();", 200);
		function auto_refresh_function() {
			$('#load_content').load('<?php echo base_url();?>kitchen/content');
		}
