			...
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<tbody>
						<?php
							foreach($urgentfoodrecord AS $urgent)
							{
						  ...
						  <tr class="danger">
							...
							<td><?php
										...
										{
											?>
											<a href="<?=base_url()?>kitchen/food_finished_cooked/<?=$urgent->order_id?>" class="btn btn-success">Done</a>
											<?php
										}
					...
					<div class="col-xs-12">
					  <table class="table table-bordered">
						...
						<?php
							...
							?>
						  <tr>
							<td align="center"><?php echo $food->table ;?></td>
							<td><?php echo $food->product_name ;?></td>
							<td><?php echo $food->full_name;?></td>
							<td align="center"><?php echo date('H:i', strtotime($food->created_time));?></td>
							<td align="center"><?php echo $food->qty;?></td>
							<td><?php
