	  ...
	  <div class="row">
		<div class="col-xs-12">
		  <div class="box box-solid box-warning">
			...
			echo form_open('purchase/pr_material_add_to_cart');?>
				<div class="box-body">
					<div class="col-xs-3">
			  ...
			  <?php
				echo form_open('purchase/pr_save','class=form-horizontal');
				?>
			  <div class="box-footer">
			    <input type="hidden" name="pr_date_required" value="<?php echo $this->session->userdata('pr_date_required');?>">
				<a href="<?php echo base_url().'purchase/pr_cancel';?>" class="btn btn-danger">Batal</a>
				<button type="submit" class="btn btn-lg btn-success pull-right">Simpan PR</button>
			  </div><!-- /.box-footer -->
			<?php echo form_close();?>
			</div><!-- /.box-body -->
		  </div><!-- /.box -->
