...
<section class="content-header">
  ...
  $group_id = $this->session->userdata('group_id');
    if( $group_id == '15' or $group_id == '14' or $group_id == '17' or $group_id == '1' OR $group_id == '2' OR $group_id == '3' OR $group_id == '4' OR $group_id == '5' OR $group_id == '6' OR $group_id == '7')
      {
        if($this->session->userdata('open_shift') == '' AND $this->session->userdata('closed_shift') == '')
        {
        ?>
        <a href="<?php echo base_url();?>order" class="btn btn-warning">Pesanan Baru</a>
  <?php if($group_id == '1' OR $group_id == '2' OR $group_id == '3' OR $group_id == '4' OR $group_id == '5' OR $group_id == '6' OR $group_id == '7'){ ?>
        <!-- <a href="<?php echo base_url();?>order/reservation" class="btn btn-primary">Reservasi</a> -->
        <?php } ?>
        <?php
          }
        }
      ?>
	<a href="<?php echo base_url();?>transaction/services_time" class="btn btn-primary">Waktu Layanan</a>
	<!--a href="<?php echo base_url();?>transaction/listdp" class="btn btn-warning">Uang Muka (DP)</a>
  <a href="<?php echo base_url();?>transaction/list_reservasi" class="btn btn-primary pull-right">List Reservasi</a-->
</section>
	  ...
	  <div class="box box-solid box-success">
		...
		<?php
			...
			?>
            	<div class="row">
            	  <div class="col-xs-12">
				<?php echo form_open('transaction/transaction_search');?>
        ...
        //if($trx->deleted_status == 1 AND ($group_id = 1 OR $group_id = 2 OR $group_id = 3 OR $group_id = 4 OR $group_id = 5 OR $group_id = 6))
				...
				<td align="center"><?php echo $trx->remark_table;?> <?php echo $trx->note;?></td>
				<td align="center"><?php
					...
					{
						echo "<span class=text-red>Pembatalan</span>";
					}
					?>
				</td>
			  </tr>
