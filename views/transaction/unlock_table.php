		...
		<div class="col-xs-8">
			<div class="box box-solid box-warning">
				...
				<div class="box-body">
					...
					<div class="form-group">
					  <label class="col-sm-3 control-label">Alasan Buka Meja</label>
					  <div class="col-xs-5">
						<textarea class="form-control" rows="5" name="note" placeholder="Alasan Buka Meja"><?php echo set_value('note');?></textarea>
					  </div>
					</div>
				</div>
