...
<section class="content-header">
	...
	<a href="<?php echo base_url();?>transaction/input_dp" class="btn btn-primary pull-right">Input (+)</a>
</section>
		...
		<?php
		  ...
		  <table id="transaction" class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				?>
			  <tr>
			    <td align="center"><a href="<?=base_url()?>transaction/detail_dp/<?=$trx->id_dp?>/<?=$trx->kode_dp?>"><?php echo $trx->kode_dp;?></a></td>
