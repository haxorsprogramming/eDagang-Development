	  ...
	  <div class="row">
        ...
        $reservation_detail_id=$trx->reservation_detail_id;
			...
			<div class="box-body">
				...
				?>
					<div class="form-group">
					  ...
					  <div class="col-sm-4">
						<input type="text" class="form-control" value="<?=number_format($total,0,',','.')?>" disabled>
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-sm-5 control-label">Disc. Items</label>
					  <div class="col-sm-3">
						<input type="text" class="form-control" value="<?=number_format($jdisc_customer,0,',','.')?>" disabled>
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-sm-5 control-label">Total</label>
					  <div class="col-sm-4">
						<input type="text" class="form-control" value="<?=number_format($total-$jdisc_customer,0,',','.')?>" disabled>
					  </div>
					</div>
                    <?php
				if(isset($customerrecord))
				...
				?>
					<div class="form-group">
					  ...
					  <div class="col-sm-4">
						<input type="text" class="form-control" value="<?=number_format($jtax,0,',','.')?> + <?=number_format($jservice,0,',','.')?>" disabled>
					  </div>
					</div>
					<?php
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-4">
						<input type="text" class="form-control" value="<?php echo number_format($grandtotal_temp,0,',','.');?>" disabled>
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-sm-5 control-label">Discount Manual</label>
					  <div class="col-sm-4">
						<input type="text" class="form-control" value="<?php echo $trx->discount_value;?>% (<?php echo number_format(($grandtotal_temp * $trx->discount_value)/100,0,',','.');?>)" disabled>
						<input type="hidden" name="discount_manual" value="<?php echo $trx->discount_value;?>">
					  </div>
					</div>
					<?php
					}
          ...
          <?php } ?>
				...
				?>
					<div class="form-group">
					  <label class="col-sm-4 control-label">ID Member</label>
					  <div class="col-sm-5">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-7">
						<input type="text" class="form-control" value="<?php echo number_format($member->saldo,0,',','.');?>" disabled>
						<input type="text" name="saldo" value="<?php echo $member->saldo;?>">
					  </div>
					</div>
				<?php }?>
				</div>
			...
			<div class="box-footer">
				...
				<input type="hidden" name="payment_method" value="saldo">
                <input type="hidden" name="customer_id" value="<?=$customer_id?>">
                <input type="hidden" name="saldo" value="<?php echo $customer_saldo;?>">
