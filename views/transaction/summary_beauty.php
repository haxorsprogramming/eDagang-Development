...
<!-- <section class="content-header">
	<a href="<?php echo base_url();?>transaction/services_time" class="btn btn-warning">Waktu Layanan</a>
  ...
  <a href="<?php echo base_url();?>transaction/list_reservasi" class="btn btn-primary pull-right">List Reservasi</a>
    ...
    if($group_id =="1" or $group_id =="2" or $group_id =="3" or $group_id =="4" or $group_id =="5"){
        ?>
        <a href="<?php echo base_url();?>transaction/listbatal" class="btn btn-warning">Histori Perubahan Transaksi</a>
        <?
    }
    ?>
</section> -->
		...
		<?php
		  ...
		  <table id="transaction" class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				{
          if($trx->order_status == 'in_door' || $trx->order_status == 'in_door'){
				?>
			  <tr>
