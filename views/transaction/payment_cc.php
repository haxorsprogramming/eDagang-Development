        ...
        $reservation_detail_id=$trx->reservation_detail_id;
			...
			<div class="col-xs-6">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-4">
					<input type="text" class="form-control" value="<?=number_format($grandtotal_temp,0,',','.')?>" disabled>
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-5 control-label">Discount Manual</label>
				  <div class="col-sm-4">
					<input type="text" class="form-control" value="<?=$invoice->discount_value?>% (<?=number_format(($grandtotal_temp * $invoice->discount_value)/100,0,',','.')?>)" disabled>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-4">
					<input type="text" class="form-control" value="<?php echo $discount_member;?>% (<?php echo number_format($disc_member,0,',','.');?>)" disabled>
