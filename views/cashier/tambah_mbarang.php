	  ...
	  <div class="row">
		<div class="col-xs-12">
		  <div class="box box-solid box-warning">
			...
			echo form_open('cashier/insert_mbarang',['class'=>'form-horizontal']);
			?>
			  <div class="box-body">
				<div class="form-group">
				  <label class="col-sm-3 control-label">Kode Barang</label>
				  <div class="col-xs-2">
					<input type="text" class="form-control" id="date_required" name="kode_barang" value="<?=$kodebarang?>">
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-xs-2">
					<input type="number" class="form-control" name="harga_barang" placeholder="Harga Barang" value="0" style="text-align:right" >
				  </div>
				</div>
                <div class="form-group">
				  <label class="col-sm-3 control-label">Stok Awal</label>
				  <div class="col-xs-2">
					<input type="number" class="form-control" name="stok_awal" placeholder="Stok Awal" value="0" style="text-align:right" >
				  </div>
				</div>
			...
			<hr>
                    ...
                    <div class="col-xs-4" style="text-align:right">
                    <strong><div id="result">0</div></strong>
                    </div>
